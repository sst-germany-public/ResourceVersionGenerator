    ...
    internal class ConsoleApplication : IDisposable
    {
        ...
        private bool WriteOutputFile(Version version, string? versionText)
        {
            ...
            try
            {
                ...
                lines.Add("// ");
                lines.Add("// This code was generated by the 'Resource-Version-Generator' tool. Any changes made manually will be overwritten next time.");
                lines.Add("");
                ...
                bool writeLinesToFile(IReadOnlyCollection<string> lines)
                {
                    try
                    {
                        using (var outputFile = new StreamWriter(path: outputFilename, append: false, encoding: Encoding.Unicode))
                        {
